...
import (
	...
	luraplugin "api-gateway/v2/modules/lura/v2/plugin"
	"api-gateway/v2/modules/lura/v2/register"
)

const (
	// Namespace is the namespace for the extra_config section
	Namespace = "api-gateway/v2/modules/lura/proxy/plugin"
	// requestNamespace is the internal namespace for the register to be used with request modifiers
	requestNamespace = "api-gateway/v2/modules/lura/proxy/plugin/request"
	// responseNamespace is the internal namespace for the register to be used with response modifiers
	responseNamespace = "api-gateway/v2/modules/lura/proxy/plugin/response"
)
