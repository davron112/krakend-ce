...
import (
	...
	lua "api-gateway/v2/modules/krakend-lua/v2"
...
const (
	ProxyNamespace   = "api-gateway/v2/modules/krakend-lua/proxy"
	BackendNamespace = "api-gateway/v2/modules/krakend-lua/proxy/backend"
)
